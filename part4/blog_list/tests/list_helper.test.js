...
describe('most blogs', () => {
	...
	test('of empty list is { \'author\' : \"None\", \'blogs\': -1}', () => {
...
describe('most liked in blog posts', () => {
	const listWithNone = []

	test('of empty list is { \'author\' : \"None\", \'likes\': -1}', () => {
		const result = listHelper.mostLikes(listWithNone)
		expect(result).toEqual({ 'author' : "None", 'likes': -1})
	})
  ...
  test('when list has only one blog, that has the most likes', () => {
	...
	test('of a bigger list returns top author that has the most liked blog posts', () => {
	...
	test('returns the first author that has the most liked blog posts', () => {
    const result = listHelper.mostLikes(blogsTwo)
    expect(result).toEqual({'author' : "Edsger W. Dijkstra", 'likes' : 24})
  })
})